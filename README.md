# Solipath Java/Maven example project
This is a quick showcase of using Solipath for a java maven project
To build from the command line:
```bash
./solipath mvn clean package
```
...
If you have an existing java maven project, all you should need to do is copy the solipath, solipath.bat (once it is there), and the solipath.json files over to your project.
